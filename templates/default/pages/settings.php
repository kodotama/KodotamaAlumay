...
<form class="standard_form" id="settings_form">
	...
	<label for="real_name"><?php $lang('real_name_label'); ?></label> <input
		type="text" name="real_name" id="real_name"
		value="<?php $esc($user['real_name']); ?>" />
	<p>&nbsp;</p>

	<label for="gender"><?php $lang('gender_label'); ?></label> <select
		name="gender" id="gender">
		<option value=""></option>
		<?php foreach($genders as $key => $gender): ?>
			<option value="<?php $esc($key); ?>"
			<?php if($user['gender'] == $key) echo 'selected'; ?>><?php $esc($gender); ?></option>
		<?php endforeach; ?>
	</select>
	<p>&nbsp;</p>
	...
	<label for="new_password"><?php $lang('new_password'); ?></label> <input
	...
	<label for="email"><?php $lang('email_label'); ?></label> <input
		...
		value="<?php $esc($user['email']); ?>" />
	<p>&nbsp;</p>
	<?php endif; ?>
	
	<h2><?php $lang('chat_settings'); ?></h2>
	<label for="enable_sounds"><?php $lang('enable_sounds'); ?></label> <input
		type="checkbox" name="enable_sounds" id="enable_sounds" value="1"
		<?php if($user['enable_sounds']) echo 'checked'; ?>>
	...
	<div class="multi_checkbox" id="timestamp_settings">
		<input type="checkbox" name="use_default_timestamp_settings"
			id="use_default_timestamp_settings" value="1"
			<?php if($user['use_default_timestamp_settings']) echo 'checked'; ?>>
		<label for="use_default_timestamp_settings"><?php $lang('use_default_timestamp_settings'); ?></label>
		<br /> <input type="checkbox" name="enable_timestamps"
			id="enable_timestamps" value="1"
			<?php if($user['enable_timestamps']) echo 'checked'; ?>> <label
			for="enable_timestamps"><?php $lang('enable_timestamps'); ?></label>
		<br /> <input type="checkbox" name="ts_24_hour" id="ts_24_hour"
			value="1" <?php if($user['ts_24_hour']) echo 'checked'; ?>> <label
			for="ts_24_hour"><?php $lang('ts_24_hour'); ?></label> <br /> <input
			type="checkbox" name="ts_show_seconds" id="ts_show_seconds" value="1"
			<?php if($user['ts_show_seconds']) echo 'checked'; ?>> <label
			for="ts_show_seconds"><?php $lang('ts_show_seconds'); ?></label> <br />
		<input type="checkbox" name="ts_show_ampm" id="ts_show_ampm" value="1"
			<?php if($user['ts_show_ampm']) echo 'checked'; ?>> <label
			for="ts_show_ampm"><?php $lang('ts_show_ampm'); ?></label>
		<!--
		<br />
	...
	<input type="checkbox" name="enable_styles" id="enable_styles"
		value="1" <?php if($user['enable_styles']) echo 'checked'; ?>>
	<p><?php $lang('show_message_styles_instr'); ?></p>

	<label for="message_font_size"><?php $lang('message_font_size'); ?></label>
	<input type="text" name="message_font_size" id="message_font_size"
		value="<?php $esc($user['message_font_size']); ?>" />
	<p><?php $lang('message_font_size_instr'); ?></p>

	<label for="message_font_color"><?php $lang('message_font_color'); ?></label>
	<input type="text" name="message_font_color" id="message_font_color"
		value="<?php $esc($user['message_font_color']); ?>" />
	...
	<select name="message_font_face" id="message_font_face">
		...
		<?php foreach($fonts as $font): ?>
			<option value="<?php $esc($font['id']); ?>"
			<?php if($user['message_font_face'] == $font['id']) echo 'selected'; ?>><?php $esc($font['name']); ?></option>
		<?php endforeach; ?>
	</select>
	<p>&nbsp;</p>
