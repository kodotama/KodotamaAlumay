...
<div id="admin_content">
	...
	<form class="standard_form" data-action="do_admin_edit_user">
		<input type="hidden" name="user_id" id="user_id"
			value="<?php $esc($val('user.id')); ?>" /> <label for="username"><?php $lang('username_label'); ?></label>
		<input type="text" name="username" id="username"
			value="<?php $var('user.username'); ?>" />
		<p>&nbsp;</p>

		<label for="email"><?php $lang('email_label'); ?></label> <input
			type="text" name="email" id="email"
			value="<?php $var('user.email'); ?>" />
		<p>&nbsp;</p>

		<label for="password"><?php $lang('password_label'); ?></label> <input
