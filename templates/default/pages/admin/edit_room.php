...
<?php 
	...
	$usageTypeId = isset ( $_GET ['usageTypeId'] ) ? $_GET ['usageTypeId'] : -1;
	...
	$(document).ready(function () {
     ...
     if(!isItCreateRoom) //If it is editing a room.
		...
		function validateForm()
		{
				...
				// SECURITY
                dbValue= $("#usageText").val();
                dbValue=htmlEncode(dbValue);
                $("#usageText").val(dbValue);
	...
	<input type="hidden" name="usage_type_id_hidden" id="usage_type_id_hidden" />
		...
		<ul id="ulId">
		    ...
		    <li   id="liUsageTools">
				...
				<textarea name="usageText" class="usageText"  id="usageText" placeholder="<?php $lang( 'usage_desc'); ?>" ><?php $esc($val('room.usage_text')); ?></textarea>
	    	 ...
	    	 <textarea name="hashtags" id="hashtags"   style="display:none; width: 349px;"  placeholder="<?php $lang( 'hashtags'); ?>"  
	    	       ></textarea>
