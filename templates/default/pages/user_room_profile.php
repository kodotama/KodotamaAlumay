...
<p>
	<b><?php $lang('ip_label'); ?></b>
</p>
<p><?php $esc($user['ip']); ?><?php if($allow_ban): ?> - <a href="#"
		id="ip_ban"><?php $lang('ban_by_ip'); ?></a><?php endif; ?></p>
<hr />
<?php endif; ?>

<p>
	<a href="#" id="start_private_chat">Start private chat</a>
</p>
<?php if($allow_ban): ?><p>
	<a href="#" id="user_ban"><?php $lang('ban_user'); ?></a>
</p><?php endif; ?>
